...
.. code-block::
    ...
    $ py.test --dburi hana://user:pass@host:port --requirements sqlalchemy_hana.requirements:Requirements --dropfirst
...
.. code-block::
    ...
    $ py.test --dburi hana://user:pass@host:port --requirements sqlalchemy_hana.requirements:Requirements --dropfirst \
      test/test_suite.py::HANAConnectionIsDisconnectedTest
